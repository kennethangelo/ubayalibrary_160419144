...
class SearchBookListAdapter(val booklistList:ArrayList<Booklist>): RecyclerView.Adapter<SearchBookListAdapter.BookListViewHolder>() {
    ...
    override fun onBindViewHolder(holder: BookListViewHolder, position: Int) {
        ...
        with(holder.view){
            ...
            btnBookListDetails.setOnClickListener {
                val action =
                    SearchFragmentDirections.actionSearchToDetailBookListFragment("booklist", booklist.id.toString())
